...
Region GenRegionA(Meta meta){
    ...
    */
    ...
    Enemy skeletonWarrior1 = Enemy("Skeleton Warrior", 3, 2, 4, 1, 0, false);
    Enemy skeletonWarrior2 = Enemy("Skeleton Warrior", 3, 2, 4, 1, 0, false);
    Enemy skeletonWarrior3 = Enemy("Skeleton Warrior", 3, 2, 4, 1, 0, false);
